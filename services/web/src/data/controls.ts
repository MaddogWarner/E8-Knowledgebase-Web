...
export const ml0GenericDescription = "ML0 means no controls implemented for this mitigation. The system is in its default state and the threats this control is designed to address are not mitigated.";
...
export const controls: EssentialControl[] = [
  {
    "id": 1,
